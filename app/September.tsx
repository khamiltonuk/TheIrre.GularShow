...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <ul>
        <li>
          <a href="/june" className="text-blue-600 visited:text-purple-600">
        ...
        <li>
          <a href="/july" className="text-blue-600 visited:text-purple-600">
        ...
        <li>
          <a href="/august" className="text-blue-600 visited:text-purple-600">
